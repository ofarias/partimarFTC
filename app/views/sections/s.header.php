            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?action=inicio">Participaciones Mariano SA de CV</a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
                <li class="list-inline">
                	<a href="index.php?action=inicio"> R E G R E S A R <i class="fa fa-reply-all"></i></a>
                </li>
                <!-- /.dropdown -->
                <li class="dropdown">
