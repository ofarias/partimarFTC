<div class="container">
        ...
        <div class="row">
           ...
           <!-- <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p>Cierre de Rutas</p>
                        <center><a href="index.php?action=cierreruta" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/designbolts/seo/64/Pay-Per-Click-icon.png"></a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Ver fallidos</h4>
                    </div>
                    <div class="panel-body">
                        <p>Ver Fallidos</p>
                        <center><a href="index.php?action=subfallidos" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/designbolts/seo/64/Pay-Per-Click-icon.png"></a></center>
                    </div>
                </div>
            </div>
           ...
           <div class="col-md-4"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Ver Re-Enrutar</h4>
                    </div>
                    <div class="panel-body">
                        <p> Ver Re-Enrutar</p>
           ...
           <div class="col-md-4"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Ver totales</h4>
                    </div>
                    <div class="panel-body">
                        <p> Ver Totales</p>
           ...
           <!-- Sub menu para ver Parcial-No-Enrutar -->
           <!--<div class="col-md-4"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Ver parcial no enrutar</h4>
                    </div>
                    <div class="panel-body">
                        <p> Ver Parcial no enrutar</p>
           ...
           <!-- Finaliza Sub menu para Parcial-No-Enrutar-->
            <!--
             <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Reporte de ordenes Fallidas</h4>
                    </div>
                    <div class="panel-body">
                        <p>Reporte de OC Fallidas</p>
                        <center><a href="index.php?action=ocfallidas" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/designbolts/seo/64/Pay-Per-Click-icon.png"></a></center>
                    </div>
                </div>
            </div> -->
        <!--
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Imprimir Validaciones</h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
                        <center><a href="index.php?action=verValidaciones" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/designbolts/seo/64/Pay-Per-Click-icon.png"></a></center>
                    </div>
                </div>
            </div>
                        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Administrar Fallidas.</h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
                        <center><a href="index.php?action=verFallidas" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>
                -->
           <!-- <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Cerrar Cajas</h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
           ...
           <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Ordenes sin recepcion</h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
                        <center><a href="index.php?action=OSRecepcion" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>
            -->
...
<!--
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Imprimir Validacion x OC </h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
                        <center><a href="index.php?action=buscaValidacionOC" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-list-alt"></i> Cierre Validaciones </h4>
                    </div>
                    <div class="panel-body">
                        <p><br></p>
                        <center><a href="index.php?action=verCierreVal" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>
            --> 
