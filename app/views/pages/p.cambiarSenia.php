                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            ...
                            <br/>
                            <input type="password" placeholder="Nueva Contraseña" id="password" required name="nuevaSenia" maxlength="10" minlength="6">
                            <br/>
                            <label> Minimo 6 caracteres y Maximo de 10, la contraseña es sesible a mayusculas y minusculas, no se permite el uso de  comillas dobles " o comillas simples ' </label>
                            <br/>
