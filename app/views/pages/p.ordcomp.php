                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-oc">
                                  ...
                                  <tbody>
                                        ...
                                        <tr class="odd gradeX" <?php echo $color;?>>
                                            ...
                                            <input type="checkbox" value="<?php echo $data->PROVE .'|'.$doc.'|'.$totalPartida.'|'.$data->ID .'|'.$con++.'|'.$doc.'|'.$data->PROD .'|'.$data->COSTO .'|'.$data->CANTI .'|'.$data->REST; ?>" name="seleccion[]" class="Selct" /></div>
                                            </td>
